...
class JaugeNaturel
{
    ...
    private BigDecimal un = new BigDecimal(1.0);
    ...
    {
        valeur = new BigDecimal(depart);
        MIN = new BigDecimal(vigieMin);
        MAX = new BigDecimal(vigieMax);
    ...
    /**
     * Getters pour la classe JaugeNaturel. Ces méthodes retournent la valeur des attributs de la classe.
     */
